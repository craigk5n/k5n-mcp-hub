...
async def check_service_health(
    ...
    *,
    ...
    if server.trace_verbose:
        from devhub.trace.recorder import sanitize_trace_headers, trim_trace_body
