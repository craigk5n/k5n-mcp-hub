...
class Metrics:
    ...
    def render_prometheus(self) -> str:
        with self._lock:
            return (
                f"devhub_requests_in_flight {self.in_flight}\n"
                f"devhub_requests_total {self.requests_total}\n"
                f"devhub_request_errors_total {self.errors_total}\n"
                f"devhub_request_duration_ms_sum {self.duration_ms_sum}\n"
            )
